...
export default async function Home() {
  const data = await db.select({ id: user.id, fullname: user.fullname, gender: user.gender, phone: user.telephone, email: user.email, hasSubmit: user.hasSubmitAnswer }).from(user)
  return (

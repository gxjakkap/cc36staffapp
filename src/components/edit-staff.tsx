        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Are you sure you want to delete {data.username}&apos;s account? 
...
export function StaffEditAndDeleteActions({ data, deleteDisabled }: { data: UWRWithUsername, deleteDisabled: boolean }){
